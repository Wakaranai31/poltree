...
<head>
    ...
    <meta name="description" content="Masuk ke sistem POLTREE dengan NIK dan kata sandi Anda.">
...
<body class="min-h-screen overflow-x-hidden bg-slate-100 font-sans text-slate-900 antialiased">
    <main class="relative isolate flex min-h-screen overflow-hidden">
        <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ asset('campus.png') }}');" aria-hidden="true"></div>
        ...
        <div class="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl items-center px-6 py-10 lg:px-10">
            <div
                ...
                <section class="max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
                    ...
                    <!-- Wadah utama agar lebarnya seragam -->
                    <div class="inline-flex flex-col items-stretch gap-4">
                        ...
                        <div class="flex items-center justify-center rounded-[14px] border border-slate/70 bg-[#f9f6ed] px-6 py-4">
                            <p class="max-w-md text-center text-sm leading-6 text-[#091057] sm:text-lg font-semibold">
                                Sistem Portal Layanan Politeknik Negeri Batam
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section
                    ...
                    <div class="mb-5 text-center lg:text-left">
                        ...
                        <p class="mt-1 text-sm leading-6 text-slate-600">Gunakan akun Anda untuk mengakses layanan</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-3" novalidate>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="group relative">
                                ...
                                <input id="nik" type="text" name="nik" autocomplete="username"
                                    value="{{ old('nik') }}" placeholder="NIK" required autofocus
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="group relative">
                                <span class="pointer-events-none absolute inset-y-0 left-4 flex items-center text-orange-500">
                                    <svg class="h-[18px] w-[18px]" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                        <path d="M7 14q-1.25 0-2.125-.875T4 11t.875-2.125T7 8t2.125.875T10 11t-.875 2.125T7 14m0 4q-2.9 0-4.95-2.05T0 11t2.05-4.95T7 4q2.5 0 4.463 1.45T14.2 9H21l2 2-3 3-2-2-2 2-2-2H14.2q-.775 2.1-2.737 3.55T7 18z"
                                            fill="currentColor" />
                                    </svg>
                                </span>
                        ...
                        @else
                        <span class="block pt-1 text-center text-sm font-medium text-blue-600/70">lupa kata sandi?</span>
                        @endif
                    </form>
                </section>
            </div>
